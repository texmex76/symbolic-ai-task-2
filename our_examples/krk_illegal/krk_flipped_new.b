...
% Set evaluation function. Can be
% coverage, compression, posonly, pbayes, accuracy, laplace
% auto_m, mestimate, entropy, gini, sd, wracc, or user
% Default coverage
:- set(evalfn,mestimate).

% Set an upper bound on the number of negative examples allowed
% to be covered by an acceptable clause.
% Default 0
:- set(noise,200).

% Set the search strategy
% bf, df, heuristic, ibs, ils, rls, scs id, ic, ar, or false
% If false, then no search is performed
% Default bf
:- set(search,bf).
...
% Set a lower bound on the number of positive examples to be
% covered by an acceptable clause
% BEWARE: you can get counter-intuitive results in conjunction with the minscore setting
:- set(minpos,2).
